class CSRMat:
    def __init__(self, rows, cols=None, eye=False):
        if cols is None:
            cols = rows
    ...
    def reset_row(self, row_start, row_end=None):
        if row_end is None:
            row_end = row_start + 1
    ...
    def remove_row(self, row_start, row_end=None):
        if row_end is None:
            row_end = row_start + 1
