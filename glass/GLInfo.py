...
class GLInfo:
	...
	format_info_map = \
	{
		...
		GL.GL_R8I: [GL.GL_RED, GL.GL_BYTE],
		GL.GL_R8UI: [GL.GL_RED, GL.GL_UNSIGNED_BYTE],
		GL.GL_R16I: [GL.GL_RED, GL.GL_SHORT],
		GL.GL_R16UI: [GL.GL_RED, GL.GL_UNSIGNED_SHORT],
		GL.GL_R32I: [GL.GL_RED, GL.GL_INT],
		GL.GL_R32UI: [GL.GL_RED, GL.GL_UNSIGNED_INT],
		...
		GL.GL_RG8I: [GL.GL_RG, GL.GL_BYTE],
		GL.GL_RG8UI: [GL.GL_RG, GL.GL_UNSIGNED_BYTE],
		GL.GL_RG16I: [GL.GL_RG, GL.GL_SHORT],
		GL.GL_RG16UI: [GL.GL_RG, GL.GL_UNSIGNED_SHORT],
		GL.GL_RG32I: [GL.GL_RG, GL.GL_INT],
		GL.GL_RG32UI: [GL.GL_RG, GL.GL_UNSIGNED_INT],
		...
		GL.GL_RGB8I: [GL.GL_RGB, GL.GL_BYTE],
		GL.GL_RGB8UI: [GL.GL_RGB, GL.GL_UNSIGNED_BYTE],
		GL.GL_RGB16I: [GL.GL_RGB, GL.GL_SHORT],
		GL.GL_RGB16UI: [GL.GL_RGB, GL.GL_UNSIGNED_SHORT],
		GL.GL_RGB32I: [GL.GL_RGB, GL.GL_INT],
		GL.GL_RGB32UI: [GL.GL_RGB, GL.GL_UNSIGNED_INT],
		...
		GL.GL_RGBA8I: [GL.GL_RGBA, GL.GL_BYTE],
		GL.GL_RGBA8UI: [GL.GL_RGBA, GL.GL_UNSIGNED_BYTE],
		GL.GL_RGBA16I: [GL.GL_RGBA, GL.GL_SHORT],
		GL.GL_RGBA16UI: [GL.GL_RGBA, GL.GL_UNSIGNED_SHORT],
		GL.GL_RGBA32I: [GL.GL_RGBA, GL.GL_INT],
		GL.GL_RGBA32UI: [GL.GL_RGBA, GL.GL_UNSIGNED_INT],
