...
vec3 get_lighting_info(in DirLight light, inout InternalMaterial material, in Camera CSM_camera, in vec3 to_camera, in vec3 frag_pos, in vec3 frag_normal) {
...
vec3 lighting(DirLight light, InternalMaterial material, Camera CSM_camera, vec3 camera_pos, vec3 frag_pos, vec3 frag_normal) {
...
vec3 get_diffuse_color(DirLight light, InternalMaterial material, Camera CSM_camera, vec3 view_dir, vec3 frag_pos, vec3 frag_normal) {
...
vec3 get_specular_color(DirLight light, InternalMaterial material, Camera CSM_camera, vec3 out_dir, vec3 frag_pos, vec3 frag_normal) {
