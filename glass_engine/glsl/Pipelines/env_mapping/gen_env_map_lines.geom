...
void main()
{
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        vec3 to_camera = normalize(camera.abs_position - gs_out.world_pos);
        ...
        gs_out.world_TBN = mat3(world_tangent, world_bitangent, world_normal);
            ...
            material.shading_model == SHADING_MODEL_GOURAUD)
        {
            ...
            gs_out.color = vec4(lighting(internal_material, CSM_camera, camera.abs_position, gs_out.world_pos, world_normal), 1.0);
        }
#endif
