...
void main()
{
    ...
    vec2 back_tex_coord = fs_in.back_tex_coord.st;
    ...
    {
        change_geometry(camera, back_material, back_tex_coord, world_TBN, world_pos);
        internal_material = fetch_internal_material(fs_in.back_color, back_material, back_tex_coord);
    }
