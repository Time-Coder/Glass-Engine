...
void write_to_gbuffer(
    ...
    out vec4 view_pos_and_alpha,
    out vec4 view_normal_and_emission_r,
    out vec4 ambient_and_emission_g,
    out vec4 diffuse_or_base_color_and_emission_b,
    out vec4 specular_or_preshading_and_shininess,
    out vec4 reflection,
    out vec4 env_center_and_mixed_value,
    out uvec4 mixed_uint
)
{
