    ...
    InternalMaterial material)
{
    ...
    vec3 diffuse_color = material.diffuse * Toonify(diffuse_factor, material.Toon_diffuse_bands, material.Toon_diffuse_softness);

    float specular_factor = Phong_specular(to_light, to_camera, normal, material.shininess);
    vec3 specular_color = material.specular * Toonify(specular_factor, material.Toon_specular_bands, material.Toon_specular_softness);
