...
class DeferredRenderer(CommonRenderer):
    ...
    def draw_opaque(self):
        ...
        with GLConfig.LocalConfig(cull_face=None, polygon_mode=GL.GL_FILL):
            ...
            self.deferred_render_program["diffuse_or_base_color_and_emission_b_map"] = (
                diffuse_or_base_color_and_emission_b_map
            )
            self.deferred_render_program["specular_and_shininess_map"] = (
                specular_and_shininess_map
            )
            self.deferred_render_program["reflection_map"] = reflection_map
            self.deferred_render_program["env_center_and_mixed_value_map"] = (
