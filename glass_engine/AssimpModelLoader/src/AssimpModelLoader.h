...
{
public:
	Texture(const std::string& _file_name): file_name(_file_name) {}
...
{
public:
	static Model load(const std::string& file_path, unsigned flags = (aiProcess_SortByPType | aiProcess_ValidateDataStructure | aiProcess_SplitLargeMeshes | aiProcess_JoinIdenticalVertices | aiProcess_Triangulate | aiProcess_CalcTangentSpace | aiProcess_GenNormals | aiProcess_GenBoundingBoxes));
};