...
class KernelFilter(Filter):
    ...
    def program(self):
        if self._program is None:
            ...
            self._program.compile(os.path.dirname(os.path.abspath(__file__)) + "/../glsl/Filters/kernel_filter.fs")
    ...
    def cube_program(self):
        if self._cube_program is None:
            ...
            self._cube_program.compile(os.path.dirname(os.path.abspath(__file__)) + "/../glsl/Filters/kernel_cube_filter.fs")
