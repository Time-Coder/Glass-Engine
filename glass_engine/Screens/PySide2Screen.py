...
class PySide2Screen(QOpenGLWidget):
    mouse_pressed = PySide2.QtCore.Signal(Manipulator.MouseButton, cgm.vec2, cgm.vec2)
    mouse_released = PySide2.QtCore.Signal(Manipulator.MouseButton, cgm.vec2, cgm.vec2)
    mouse_double_clicked = PySide2.QtCore.Signal(
        Manipulator.MouseButton, cgm.vec2, cgm.vec2
    )
    mouse_moved = PySide2.QtCore.Signal(cgm.vec2, cgm.vec2)
    wheel_scrolled = PySide2.QtCore.Signal(cgm.vec2, cgm.vec2, cgm.vec2)
